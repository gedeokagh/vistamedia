...
<!--PAGE CONTENT -->
        <div id="content">
            ...
            <div class="inner">
                ...
                <div class="col-lg-12">
					...
					<?php 
						if(Code::requery("usrprev","AddNew","IDUser='".Session::get('ID')."' and IDModule=2")<>0){
						$lloc=Code::GetField("usrprev","AddNew","IDUser='".Session::get('ID')."' and IDModule=2");											
						if($lloc==1){?>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="example">
                                    ...
                                    <tbody>
									<?php
									if(Code::requery("usrprev","AddIMG","IDUser='".Session::get('ID')."' and IDModule=2")<>0){
											$adds=Code::GetField("usrprev","AddIMG","IDUser='".Session::get('ID')."' and IDModule=2");											
									}
									if(Code::requery("usrprev","Changes","IDUser='".Session::get('ID')."' and IDModule=2")<>0){
											$chgs=Code::GetField("usrprev","Changes","IDUser='".Session::get('ID')."' and IDModule=2");										
									}
									if(Code::requery("usrprev","Void","IDUser='".Session::get('ID')."' and IDModule=2")<>0){
											$void=Code::GetField("usrprev","Void","IDUser='".Session::get('ID')."' and IDModule=2");										
									}
									foreach ($this->IjinreklameList as $key => $value) {
                                        ...
                                        <tr class="odd gradeX">
											...
											<td  nowrap>
											<a class="btn btn-primary btn-circle" href="<?php echo URL;?>admin/ListIjin/<?php echo $value['ProductID']; ?>-2"><i class="icon-list"></i></a>
											<?php if($value['NoIjin']!=""){
											if($chgs==1){?>
											<a class="btn btn-primary btn-circle" href="<?php echo URL;?>admin/editIjinreklame/<?php echo $value['ID']; ?>"><i class="icon-check"></i></a><?php }
											if($void==1){?>
												<a class="btn btn-danger btn-circle" href="<?php echo URL;?>admin/DeleteIjinReklame/<?php echo $value['ID']; ?>"><i class="icon-remove"></i></a><?php 
											}
											}?></td>
	...
	$('.dfl').click(function(){ 	
		...
		vlink.href='<?php echo URL."admin/cIjinreklameList/";?>'+ck+'-'+ca;
		vlink.target="_blank";
