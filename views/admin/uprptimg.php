...
<!--PAGE CONTENT -->
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             Upload New Images <small>[ <a href="<?php echo URL."admin/listrpt";?>">back</a> ]</small>
                        </div>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              Daftar Gambar <small>[ <a href="<?php echo URL."admin/listrpt"?>">back</a> ]</small>
                            </div>
		...
		<a class="dfl btn btn-success" id="dfl" href="#" style="color:#fff;" rel="<?php echo $value['ID']; ?>" > Set Default </a>
		<?php }else{?>
		<a class="udfl btn btn-warning" id="udfl" href="#" style="color:#fff;" rel="<?php echo $value['ID']; ?>" >Unset Default </a>
		<?php }?>
	...
	$('.del').click(function(){
		...
		//alert(gid);
		$.post("../rptimgdel",{gid:gid},function(x){
        //alert(x);
		delItem.remove();
		});
	return false;
	...
	$('.dfl').click(function(){
		...
		var el =$(this).parent();
		//alert(gid);
		$.post("../setdef",{gid:gid},function(x){});
		$(this).remove();
		el.append('<a class="udfl btn btn-warning" id="udfl" href="#" style="color:#fff;" rel="' + gid + '" onclick="udfl($(this));">Unset Default </a>');
	return false;
	});
	...
	$('.udfl').click(function(){
		...
		var el =$(this).parent();
		//alert(gid);
		$.post("../unsetdef",{gid:gid},function(x){});
		$(this).remove();
		el.append('<a class="dfl btn btn-success" id="dfl" href="#" style="color:#fff;" rel='+gid+'  onclick="dfl($(this));" > Set Default </a>');
	return false;
	});
	function dfl(x){
