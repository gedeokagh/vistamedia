                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="example">
									...
									foreach ($this->prolist as $key => $value) {
										?>
                                        <tr class="odd gradeX">
                                            <td  nowrap><a href="<?php echo URL;?>admin/uprptAdd/<?php echo $value["ID"];?>" ><?php echo $value['ProductCode']; ?></a></td>
											...
											<td  nowrap><a href="<?php echo URL;?>admin/uprptAdd/<?php echo $value["ID"];?>" ><i class="icon-check"></i></a></td>
                                        </tr>
									<?php }?>
                                    </tbody>
                                </table>
