      ...
      <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add New IMBR</h1>
					<small>[ <a href="<?php echo URL;?>admin/IMBRList"><< Back</a> ]</small>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo URL; ?>admin/saveIMBR" method="POST"  enctype="multipart/form-data" >
