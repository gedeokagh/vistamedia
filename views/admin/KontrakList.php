        ...
        <div id="content">
            ...
            <div class="inner">
                ...
                <div class="col-lg-12">
					...
					<?php 
						if(Code::requery("usrprev","AddNew","IDUser='".Session::get('ID')."' and IDModule=5")<>0){
						$lloc=Code::GetField("usrprev","AddNew","IDUser='".Session::get('ID')."' and IDModule=5");											
						if($lloc==1){?>
                        <div class="panel-heading">
                             <a href="<?php echo URL;?>admin/KontrakAdd">[ <i class="icon-plus"></i> Add New ]</a>
                        </div>
						<?php }}?>
                               ...
                               <table class="table table-striped table-bordered table-hover" id="example">
                                    ...
                                    <tbody>
											...
											if(Code::requery("usrprev","Changes","IDUser='".Session::get('ID')."' and IDModule=5")<>0){
												$edit=Code::GetField("usrprev","Changes","IDUser='".Session::get('ID')."' and IDModule=5");	
									...
									foreach ($this->KontrakList as $key => $value) {
                                        ...
                                        <tr class="odd gradeX">
											...
											if($edit==1){ ?><a class="btn btn-primary btn-circle" href="<?PHP echo URL;?>admin/editKontrak/<?php echo $value["KontrakID"];?>"><i class="icon-check"></i></a><?php }
											if($void==1){?><a class="btn btn-danger btn-circle" href="<?PHP echo URL;?>admin/DelKontrak/<?php echo $value["KontrakID"];?>"><i class="icon-remove"></i></a><?php }
											}?></td>											
                                        </tr>
									<?php }?>
                                    </tbody>
