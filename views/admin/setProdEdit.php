                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="<?php echo URL; ?>admin/sendMailUpdate" method="POST"  enctype="multipart/form-data" >
										...
										<div class="col-sm-12">
											...
											for($x=1;$x<=31;$x++){
												...
												if (in_array($x,$this->lst)){ echo " checked >";}else{ echo ">";}
												if ($x<10){ echo "0";}
												echo $x.'</label>';
												if (($x % 10)==0){
										...
										<div class="col-sm-6">
											...
											$x++;
												...
												<input type="hidden" class="form-control" id="expdate" name="expdate" required value="<?php echo $this->expdate;?>">
												<input type="hidden" class="form-control" id="id" name="id" required value="<?php echo $this->id;?>">
										</div>
										</div>
										</div>
										...
										<div class="col-sm-6">
										 ...
										 echo $this->sender;
											foreach ($this->setsender as $key => $value){
												if ($this->sender==$value["ID"]){
													$print="<div class='checkbox'><input class='uniform' id='opt' name='opt'  type='radio' value='".$value["ID"]."' checked";
