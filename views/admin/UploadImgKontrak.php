...
<!--PAGE CONTENT -->
            ...
            <div class="inner" style="min-height: 700px;">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						Upload Gambar <small>[ <a href='<?php echo URL;?>admin/KontrakList'>back</a> ]</small>
                        </div>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                             Daftar Gambar <small>[ <a href='<?php echo URL;?>admin/KontrakList'>back</a> ]</small>
                            </div>
		...
		<div id="mexp">
		<a id="example5" ><img src="<?php echo URL.$value['Img']; ?>" alt="" width="200px;" height="auto" /></a><br><?php echo $value['Keterangan']; ?><br>
	...
	$('.del').click(function(){
		...
		//alert(gid);
		$.post("../delupkontrak",{gid:gid},function(x){
        //alert(x);
		delItem.remove();
		});
	return false;
