...
<!--PAGE CONTENT -->
        <div id="content">
			...
			<p style="text-align:center">
			 <?php
			 if(empty($this->ListRptImg)){
				 echo "Blm Ada Data Gambar untuk periode sekarang";
			 }else{
                        foreach ($this->ListRptImg as $key => $value){
                        ?>
		...
		<br>
		<a id="example5" href="<?php echo URL.$value['img']; ?>" ><img src="<?php echo URL.$value['img']; ?>" alt="" width="400px;" height="auto" /></a>
