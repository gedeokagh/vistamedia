      ...
      <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner"  style="min-height:400px;">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add New Demo User</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="<?php echo URL; ?>admin/savekirimlokasi" method="POST"  enctype="multipart/form-data" >
...
<tr><td>							<div id="mydata">
										...
										<div class="col-lg-6">
											...
											<input type="hidden" class="form-control" id="ID" name="ID" required value="<?php echo Code::random_string();?>">
										</div>
                                        </div>
										<div class="form-group">
										<div class="col-lg-6">
										...
										<div class="col-lg-6">
                                            ...
                                            <input class="form-control" id="mailto" name="mailto" required>
										</div>
                                        </div>
										<div class="form-group">
										<div class="col-lg-6">
										...
										<div class="col-lg-6">
											...
											<input class="timepicker-24 form-control" name="time" type="text" />
										...
										<div class="col-lg-6">
										 ...
										 <?php
											foreach ($this->setsender as $key => $value){
												echo "<div class='checkbox'><input class='uniform' id='opt' name='opt'  type='radio' value='".$value["ID"]."'> ".$value["name"]."</div>";
											}
										?>	                      
