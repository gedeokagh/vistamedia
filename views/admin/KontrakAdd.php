      ...
      <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add New Data Penjualan</h1>
					<small>[ <a href="<?php echo URL;?>admin/KotrakList"><< back</a> ]</small>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo URL; ?>admin/saveKontrak" method="POST"  enctype="multipart/form-data" >
										...
										<div class="form-group">
											...
											<?php foreach ($this->propertylist as $key => $value) {?>
                                                <option value="<?php echo $value["ID"];?>"><?php echo $value["ProductCode"];?> | <?php echo $value["Address"];?></option>
											<?php }?>
                                            </select>
                                        </div>
										<div class="form-group">
