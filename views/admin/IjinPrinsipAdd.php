      ...
      <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add New Ijin Prinsip Reklame</h1><small>[<a href="<?php echo URL;?>admin/IjinPrinsipList"><< Back</a>]</small>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo URL; ?>admin/saveIjinPrinsip" method="POST"  enctype="multipart/form-data" >
