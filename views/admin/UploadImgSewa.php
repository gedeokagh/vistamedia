...
<!--PAGE CONTENT -->
            ...
            <div class="inner" style="min-height: 700px;">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						Upload Gambar <small>[ <a href='<?php echo URL;?>admin/SewaList'>back</a> ]</small>
                        </div>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                             Daftar Gambar <small>[ <a href='<?php echo URL;?>admin/SewaList'>back</a> ]</small>
                            </div>
	...
	$('.del').click(function(){
		...
		//alert(gid);
		$.post("../delupsewa",{gid:gid},function(x){
        //alert(x);
		delItem.remove();
		});
	return false;
